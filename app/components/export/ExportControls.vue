...
<template>
  <div class="bg-gradient-to-br from-green-50 to-blue-50 rounded-lg border-2 border-green-200 shadow-lg p-6">
    <div class="flex items-center justify-between mb-4">
      <h2 class="text-xl font-bold text-gray-900">📥 Export Cleaned Data</h2>
    ...
    <div class="space-y-4">
      ...
      <div class="flex items-center space-x-3">
        <UiButton
          ...
          class="flex-1 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
          @click="handleExport"
        >
